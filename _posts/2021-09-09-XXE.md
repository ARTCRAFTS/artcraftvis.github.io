...
layout: single
title: XXE
excerpt: XML External Entity XXE attack is a vulnerability that abuses features of XML parsers and data. It often allows an attacker to interact with any backend or external systems that the application itself can access and can allow the attacker to read the file on that system. They can also cause Denial of Service DoS attack or could use XXE to perform Server-Side Request Forgery SSRF inducing the web application to make requests to other applications.
date: 2021-08-31
classes: wide
header:
...
![image](https://user-images.githubusercontent.com/89842187/132744760-6becc160-494b-44d2-b167-78242b0f9572.png)
...
![image](https://user-images.githubusercontent.com/89842187/132744774-cebe0302-201a-48ca-b9e7-2ee8f5da2d79.png)
